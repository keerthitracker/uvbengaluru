    ...
    <footer className="bg-[#080808] border-t border-[#222]">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li>
              <a href="tel:+918045678900" className="text-[#888] hover:text-[#C8FF00] transition-colors text-sm">
                +91 80 4567 8900
              </a>
            </li>
            <li>
      ...
      <div className="border-t border-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-2">
          <p className="text-[#444] text-xs">© 2025 UV Bengaluru. Operated by Aadya Inc.</p>
          <p className="text-[#444] text-xs">Authorized Ultraviolette Dealership · Nagarbhavi, Bengaluru</p>
        </div>
      </div>
    </footer>
  )
