        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="text-[#888] text-sm">Nagarbhavi Cross, Bengaluru – 560072</p>
            </div>
            <div>
              <svg className="w-8 h-8 text-[#C8FF00] mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-[#888] text-sm">Mon–Sat: 9:30 AM – 7:00 PM<br />Sunday: 10:00 AM – 5:00 PM</p>
            </div>
            <div>
              <svg className="w-8 h-8 text-[#C8FF00] mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-[#888] text-sm">+91 80 4567 8900<br />hello@uvbengaluru.com</p>
            </div>
          </div>
        </div>
      </section>
