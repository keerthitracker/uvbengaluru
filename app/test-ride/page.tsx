    ...
    <>
      ...
      <section className="hero-gradient pt-32 pb-20 px-4 md:px-8 border-b border-[#1a1a1a]">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-[#FF3B3B] text-xs uppercase tracking-[0.3em] mb-4 font-semibold">UV Bengaluru · Nagarbhavi</p>
          <h1
            className="font-display text-5xl md:text-7xl font-extrabold uppercase leading-none text-white mb-6"
           
          >
            FEEL THE<br />
            <span className="text-[#FF3B3B]">DIFFERENCE.</span><br />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step) => (
              <div key={step.step} className="text-center">
                <div
                  className="w-14 h-14 bg-[#E8231A] text-black text-xl font-extrabold flex items-center justify-center mx-auto mb-6"
      ...
      <section className="py-24 px-4 md:px-8">
        <div className="max-w-2xl mx-auto">
          <div className="mb-12 text-center">
            <p className="text-[#FF3B3B] text-xs uppercase tracking-[0.3em] mb-3 font-semibold">Reserve Your Slot</p>
            <h2 className="font-display text-4xl md:text-5xl font-extrabold uppercase text-white">
              BOOK YOUR<br />TEST RIDE
            </h2>
      ...
      <section className="py-16 px-4 md:px-8 bg-[#0c0c0c] border-t border-[#1a1a1a]">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <svg className="w-8 h-8 text-[#FF3B3B] mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p className="text-[#888] text-sm"><a href="tel:+919606955530" className="hover:text-white transition-colors">96069 55530</a><br /><a href="https://wa.me/919606955529" className="hover:text-white transition-colors">WA: 96069 55529</a></p>
            </div>
          </div>
        </div>
      </section>
