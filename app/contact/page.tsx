        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {contactInfo.map((info) => (
              <div key={info.title} className="bg-[#111] border border-[#222] p-8 hover:border-[#E8231A] transition-colors duration-300">
                ...
                <a
                  ...
                  className="text-[#FF3B3B] text-xs font-bold uppercase tracking-widest hover:text-white transition-colors flex items-center gap-2"
                >
                  {info.cta.label}
      ...
      <section className="py-24 px-4 md:px-8">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-16 items-start">
          ...
          <div className="lg:col-span-2">
            <div className="mb-10">
              <p className="text-[#FF3B3B] text-xs uppercase tracking-[0.3em] mb-3 font-semibold">Send a Message</p>
          ...
          <div className="space-y-8">
              ...
              <ul className="space-y-4">
                {socials.map((s) => (
                  <li key={s.label}>
                    ...
                    >
                      <span className="text-white text-sm font-medium group-hover:text-white transition-colors">{s.label}</span>
                      <span className="text-[#666] text-xs group-hover:text-white transition-colors">{s.handle}</span>
                    </a>
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-[#E8231A]/5 border border-[#E8231A]/20 p-6">
              <h3 className="text-base font-bold uppercase text-[#FF3B3B] mb-3">READY TO RIDE?</h3>
              <p className="text-[#888] text-sm leading-relaxed mb-4">
                Skip the form — book a test ride directly and experience the Ultraviolette difference.
              </p>
              <a
                href="/test-ride"
                className="block text-center bg-[#E8231A] text-white font-bold uppercase tracking-widest py-3 text-xs hover:bg-[#C41C14] transition-colors"
              >
                BOOK TEST RIDE
              </a>
            </div>
