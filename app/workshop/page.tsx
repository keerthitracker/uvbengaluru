    ...
    <>
      ...
      <section className="hero-gradient pt-32 pb-20 px-4 md:px-8 border-b border-[#1a1a1a]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            EXPERT SERVICE.<br />
            <span className="text-[#C8FF00]">UNCOMPROMISED</span><br />
            PERFORMANCE.
          </h1>
      ...
      <section className="py-24 px-4 md:px-8 border-b border-[#1a1a1a]">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <p className="text-[#C8FF00] text-xs uppercase tracking-[0.3em] mb-3 font-semibold">What We Do</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service) => (
              <div key={service.title} className="bg-[#111] border border-[#222] p-6 hover:border-[#C8FF00] transition-colors duration-300">
      ...
      <section className="py-24 px-4 md:px-8 bg-[#0c0c0c] border-b border-[#1a1a1a]">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 text-center">
            <p className="text-[#C8FF00] text-xs uppercase tracking-[0.3em] mb-3 font-semibold">Why UV Bengaluru Workshop</p>
            <h2 className="font-display text-4xl md:text-5xl font-extrabold uppercase text-white">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {reasons.map((r) => (
              <div key={r.title} className="text-center">
                <div className="w-12 h-12 bg-[#C8FF00]/10 border border-[#C8FF00]/20 flex items-center justify-center mx-auto mb-5">
      ...
      <section className="py-24 px-4 md:px-8 border-b border-[#1a1a1a]">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <p className="text-[#C8FF00] text-xs uppercase tracking-[0.3em] mb-3 font-semibold">How It Works</p>
            <h2 className="font-display text-4xl md:text-5xl font-extrabold uppercase text-white">
              THE SERVICE PROCESS
            </h2>
          </div>
            ...
            {processSteps.map((step, idx) => (
              <div key={step.step} className="relative">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 bg-[#C8FF00] text-black flex items-center justify-center font-extrabold text-sm mb-4">
                    {step.step}
                  </div>
      ...
      <section className="py-24 px-4 md:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="mb-12">
            <p className="text-[#C8FF00] text-xs uppercase tracking-[0.3em] mb-3 font-semibold">Book a Service</p>
            <h2 className="font-display text-4xl md:text-5xl font-extrabold uppercase text-white">
