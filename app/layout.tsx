  ...
  return (
    <html lang="en" className={`${inter.variable} ${barlowCondensed.variable}`}>
      <body className="bg-[#080808] text-white antialiased" style={{ fontFamily: 'var(--font-inter), Inter, sans-serif' }}>
        ...
        <a
          href="https://wa.me/919606955529?text=Hi%2C%20I'm%20interested%20in%20Ultraviolette%20motorcycles"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Chat on WhatsApp"
          className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg hover:bg-[#20bd5a] transition-all duration-200 hover:scale-110"
        >
