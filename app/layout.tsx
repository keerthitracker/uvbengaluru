...
export const metadata: Metadata = {
  ...
  title: {
    default: "UV Bengaluru - Official Ultraviolette Dealership in Nagarbhavi",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "UV Bengaluru official Ultraviolette dealership",
      },
    ],
  },
  twitter: {
