...
function VehicleCard({ vehicle }: { vehicle: Vehicle }) {
  ...
  return (
    ...
    >
      <div
        className={`relative aspect-[16/10] ${getVehicleImageFrameClass(vehicle.cardImage, "light")}`}
      >
        <VehicleImage
      ...
      <div className="p-6">
        ...
        <h3 className="font-display mb-2 text-2xl font-bold uppercase tracking-[0.06em] text-white">
          {vehicle.name}
        </h3>
        ...
        <div className="mb-5 grid grid-cols-3 gap-3">
          {vehicle.heroStats.slice(0, 3).map((spec) => (
            <div key={spec.label}>
              ...
              <p className="mt-1 text-[10px] uppercase tracking-[0.06em] text-[#777]">
                {spec.label}
              </p>
            </div>
          ))}
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <span className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#FF3B3B]">
            View Details
          </span>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <section className="bg-[#111] px-4 py-20 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h2 className="mb-2 text-sm font-semibold uppercase tracking-[0.16em] text-[#A0A0A0]">
              Pre-book / Register Interest
            </h2>
            <p className="text-sm text-[#666]">
              Upcoming models stay in pre-book mode until final retail
      ...
      <section className="bg-[#0D0D0D] px-4 py-20 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h2 className="mb-2 text-sm font-semibold uppercase tracking-[0.16em] text-[#A0A0A0]">
              Racing And Story Showcase
            </h2>
            <p className="text-sm text-[#666]">
              Not normal dealership inventory. Use these pages for brand
              credibility and limited-edition storytelling.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
      ...
      <section className="border-t border-[#2A2A2A] bg-[#0D0D0D] px-4 py-16 text-center md:px-8">
        ...
        <p className="mb-8 text-sm text-[#A0A0A0]">
          Book a test ride or speak to the showroom team for current
          ex-showroom, on-road, offer, and delivery details.
        </p>
      ...
      <section className="border-t border-[#2A2A2A] bg-[#111] px-4 py-20 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-10">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                text: "Use this page to understand current F77 price context before you request the exact showroom quote.",
                href: "/f77-price-bengaluru",
              },
              {
                title: "F77 Mach 2 vs F77 SuperStreet",
                text: "A direct comparison for riders deciding between the sport-focused and street-focused F77 expressions.",
              ...
              >
                <h3 className="font-display mb-3 text-xl font-bold uppercase tracking-[0.06em] text-white">
                  {guide.title}
                </h3>
                <p className="mb-5 text-sm leading-relaxed text-[#A0A0A0]">
                  {guide.text}
